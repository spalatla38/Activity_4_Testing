...
class AverageTest {
    ...
    public void averageWithNonEmptyList(){
        ...
        // Test Case that are designed to fail
            // Expected output : 88, Actual Output : 0
            assertEquals(88, avg.average(0, singleElementList));

            // Expected output : 11, Actual Output : 0
            assertEquals(11, avg.average(0, multipleElementList));

            // Expected output : 38, Actual Output : 39
            assertEquals(38, avg.average(3, multipleElementList));

            //  Expected output : 39, Actual Output : 38
        assertEquals(39, avg.average(4, multipleElementList));
    }
}